...
class ReviewerTest : RobolectricTest() {
    ...
    private fun toggleWhiteboard(reviewer: ReviewerForMenuItems) {
        ...
        assumeTrue("Whiteboard should now be enabled", reviewer.whiteboardController.isEnabled)
...
val Reviewer.isDisplayingMark: Boolean get() = this.viewModel.state.value.isMarked
