...
class IntroductionI18nTest : RobolectricTest() {
    ...
    fun stringsEnglish() {
        ...
        assertEquals(
            "This app is a fork of AnkiDroid. Please consider donating to the AnkiDroid team to support their work. The creator of Anki has also kindly allowed the use of AnkiWeb sync. If you'd like to support him, please consider buying the iPhone version of Anki.",
            donation,
        )
